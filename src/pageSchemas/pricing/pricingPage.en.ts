            ...
            cards: [
                {
                    ...
                    price: "€9",
                    tokens: 900,
                    badgeTop: "For Beginners",
                    description:
                        "Perfect to get started. Generate your first business plan with AI and explore the platform using tokens.",
                    features: [
                        "AI-generated business plans",
                        "Fast results in seconds",
                        "Edit & regenerate anytime",
                        "Uses tokens per generation",
                    ],
                ...
                },
                {
                    ...
                    price: "€50",
                    tokens: 5000,
                    badgeTop: "Professional",
                    description:
                        "For serious projects. Get a high-quality business plan crafted with expert involvement for maximum accuracy and depth.",
                    features: [
                        "Human expert-crafted plans",
                        "Higher quality & deeper analysis",
                        "Priority processing",
